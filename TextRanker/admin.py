...
class CustomUserAdmin(admin.ModelAdmin):
    ...
    ordering = ['email']
    list_filter = ['email', 'verified_account', 'account_under_review', 'account_banned']
    
    # Ensure the fields in 'fields' and 'fieldsets' reflect the current model
    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        ('Personal info', {'fields': ('verified_account', 'account_under_review', 'account_banned', 'ban_datetime', 'ban_removal_datetime', 'ban_reason')}),
    ...
    list_display = ('email', 'verified_account', 'account_under_review', 'account_banned', 'date_joined', 'last_login')
